...
public Palm01Instanced(){
		...
		List<Matrix4f> instancedWorldMatrices = ResourceLoader.loadObjectTransforms("./res/oreonworlds/assets/plants/Palm_01/Palm_01_instancedtransforms.txt");
		List<Matrix4f> instancedModelMatrices = ResourceLoader.loadObjectTransformsModelMatrix("./res/oreonworlds/assets/plants/Palm_01/Palm_01_instancedtransforms.txt");
