...
import oreonworlds.shaders.Bush01InstancedShader;
import oreonworlds.shaders.Bush01InstancedShadowShader;
...
public class Bush01Instanced extends Node{
	...
	public Bush01Instanced(){
		...
		Model[] models = loader.load("./res/oreonworlds/plants/Bush_01","Bush_01.obj","Bush_01.mtl");
		
		List<Matrix4f> instancedWorldMatrices = ResourceLoader.loadObjectTransforms("./res/oreonworlds/plants/Bush_01/Bush_01_instancedtransforms.txt");
		List<Matrix4f> instancedModelMatrices = ResourceLoader.loadObjectTransformsModelMatrix("./res/oreonworlds/plants/Bush_01/Bush_01_instancedtransforms.txt");
		...
		UBO ubo = new UBO();
		ubo.setBinding_point_index(Constants.Bush01InstancedMatrices);
		ubo.bindBufferBase();
