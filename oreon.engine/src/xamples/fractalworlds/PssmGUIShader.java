...
public class PssmGUIShader extends Shader{
	...
	protected PssmGUIShader()
	{
		...
		addVertexShader(ResourceLoader.loadShader("demos/FractalWorlds/PssmGUI_VS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("demos/FractalWorlds/PssmGUI_FS.glsl"));
		compileShader();
