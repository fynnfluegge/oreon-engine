...
public class TerrainShader extends Shader{
	...
	protected TerrainShader()
	{
		...
		addGeometryShader(ResourceLoader.loadShader("demos/FractalWorlds/Terrain/shader/Terrain_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("demos/FractalWorlds/Terrain/shader/Terrain_FS.glsl"));
		compileShader();
