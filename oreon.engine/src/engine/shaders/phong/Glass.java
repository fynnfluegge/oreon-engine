...
public class Glass extends Shader{
	...
	protected Glass()
	{
		...
		addVertexShader(ResourceLoader.loadShader("shaders/phong/glass/Vertex.glsl"));
		addFragmentShader(ResourceLoader.loadShader("shaders/phong/glass/Fragment.glsl"));
		compileShader();
