...
public class TerrainShader extends Shader{
	...
	protected TerrainShader()
	{
		...
		addGeometryShader(ResourceLoader.loadShader("demos/FractalWorlds/Terrain_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("demos/FractalWorlds/Terrain_FS.glsl"));
		compileShader();
