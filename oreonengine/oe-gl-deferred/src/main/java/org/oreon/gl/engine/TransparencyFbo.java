...
public class TransparencyFbo extends GLFrameBufferObject{
	...
	public TransparencyFbo(int width, int height) {
		...
		GLTexture albedoTexture = new TextureImage2D(width, height,
				ImageFormat.RGBA16FLOAT, SamplerFilter.Nearest, TextureWrapMode.None);
		GLTexture alphaTexture = new TextureImage2D(width, height,
				ImageFormat.RGBA16FLOAT, SamplerFilter.Nearest, TextureWrapMode.None);
		GLTexture lightScatteringMask = new TextureImage2D(width, height,
				ImageFormat.RGBA16FLOAT, SamplerFilter.Nearest, TextureWrapMode.None);
		GLTexture depthTexture = new TextureImage2D(width, height,
