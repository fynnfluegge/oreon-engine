...
public class PalmShadowShader extends GLShader{
	...
	protected PalmShadowShader()
	{
		...
		addGeometryShader(ResourceLoader.loadShader("oreonworlds2/shaders/assets/Palm_Shader/Palm01Shadow_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("oreonworlds2/shaders/assets/Palm_Shader/Palm01Shadow_FS.glsl"));
		compileShader();
