...
public class OceanBRDFShader extends GLShader{
	...
	protected OceanBRDFShader()
	{
		...
		addVertexShader(ResourceLoader.loadShader("oreonworlds2/shaders/Ocean_Shader/Ocean_VS.glsl"));
		addTessellationControlShader(ResourceLoader.loadShader("oreonworlds2/shaders/Ocean_Shader/Ocean_TC.glsl"));
		addTessellationEvaluationShader(ResourceLoader.loadShader("oreonworlds2/shaders/Ocean_Shader/Ocean_TE.glsl"));
		addGeometryShader(ResourceLoader.loadShader("oreonworlds2/shaders/Ocean_Shader/Ocean_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("oreonworlds2/shaders/Ocean_Shader/Ocean_FS.glsl"));
		compileShader();
