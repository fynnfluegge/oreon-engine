...
public class PalmBillboardShader extends GLShader{
	...
	protected PalmBillboardShader()
	{
		...
		addGeometryShader(ResourceLoader.loadShader("oreonworlds2/shaders/assets/Palm_Shader/Palm01_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("oreonworlds2/shaders/assets/Palm_Shader/Palm01Billboard_FS.glsl"));
		compileShader();
