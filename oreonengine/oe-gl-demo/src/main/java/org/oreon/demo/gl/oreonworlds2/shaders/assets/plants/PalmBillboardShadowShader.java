...
public class PalmBillboardShadowShader extends GLShader{
	...
	protected PalmBillboardShadowShader()
	{
		...
		addVertexShader(ResourceLoader.loadShader("oreonworlds2/shaders/assets/Palm_Shader/Palm01_VS.glsl"));
		addGeometryShader(ResourceLoader.loadShader("oreonworlds2/shaders/assets/Palm_Shader/Palm01BillboardShadow_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("oreonworlds2/shaders/assets/Palm_Shader/Palm01BillboardShadow_FS.glsl"));
		compileShader();
