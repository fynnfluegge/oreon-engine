...
private static OceanGridShader instance = null;
	...
	protected OceanGridShader()
	{
		...
		addVertexShader(ResourceLoader.loadShader("src/main/resources/oreonworlds/shaders/ocean/Ocean_VS.glsl"));
		addTessellationControlShader(ResourceLoader.loadShader("src/main/resources/oreonworlds/shaders/ocean/Ocean_TC.glsl"));
		addTessellationEvaluationShader(ResourceLoader.loadShader("src/main/resources/oreonworlds/shaders/ocean/Ocean_TE.glsl"));
		addGeometryShader(ResourceLoader.loadShader("src/main/resources/oreonworlds/shaders/ocean/OceanGrid_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("src/main/resources/oreonworlds/shaders/ocean/OceanGrid_FS.glsl"));
		compileShader();
