...
public class SwapChainDescriptor {
	...
	public SwapChainDescriptor(VkDevice device, DescriptorPool descriptorPool, long imageView) {
	    ...
	    set = new DescriptorSet(device, descriptorPool.getHandle(), layout.getHandlePointer());
