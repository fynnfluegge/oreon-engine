...
public class WireframeButton extends Button{
	...
	{
		buttonMap = new Texture2DBilinearFilter("./res/gui/tex/buttons.png");
		buttonClickMap = new Texture2DBilinearFilter("./res/gui/tex/buttonsClicked.png");
	...
	{
		EngineContext.getRenderState().setWireframe(!EngineContext.getRenderState().isWireframe());
	}
