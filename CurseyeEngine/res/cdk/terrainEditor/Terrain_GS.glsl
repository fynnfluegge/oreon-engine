...
void main() {
	...
	if (dist < largeDetailedRange){
		...
		float displaceSand0 = texture(sand0.displacemap, texCoordG[0]).r * (sand0.displaceScale);
		float displaceRock0 = texture(rock0.displacemap, texCoordG[0]).r * (rock0.displaceScale);
		float displaceSnow0 = texture(snow0.displacemap, texCoordG[0]).r * (snow0.displaceScale);
		
		float displaceSand1 = texture(sand0.displacemap, texCoordG[1]).r * (sand0.displaceScale);
		float displaceRock1 = texture(rock0.displacemap, texCoordG[1]).r * (rock0.displaceScale);
		float displaceSnow1 = texture(snow0.displacemap, texCoordG[1]).r * (snow0.displaceScale);
		
		float displaceSand2 = texture(sand0.displacemap, texCoordG[2]).r * (sand0.displaceScale);
		float displaceRock2 = texture(rock0.displacemap, texCoordG[2]).r * (rock0.displaceScale);
		float displaceSnow2 = texture(snow0.displacemap, texCoordG[2]).r * (snow0.displaceScale);
