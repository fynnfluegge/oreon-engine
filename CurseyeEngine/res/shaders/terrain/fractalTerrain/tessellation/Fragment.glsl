...
{		
	...
	vec2 mapCoords = (position.xz + scaleXZ/2)/scaleXZ;
	 ...
	 vec3 normal = normalize(
							 (2*(texture(fractals2[0].normalmap, mapCoords*fractals2[0].scaling).rbg)-1)
							+(2*(texture(fractals2[1].normalmap, mapCoords*fractals2[1].scaling).rbg)-1)
							+(2*(texture(fractals2[2].normalmap, mapCoords*fractals2[2].scaling).rbg)-1)
							+(2*(texture(fractals2[3].normalmap, mapCoords*fractals2[3].scaling).rbg)-1)
							+(2*(texture(fractals2[4].normalmap, mapCoords*fractals2[4].scaling).rbg)-1)
							+(2*(texture(fractals2[5].normalmap, mapCoords*fractals2[5].scaling).rbg)-1)
							+(2*(texture(fractals2[6].normalmap, mapCoords*fractals2[6].scaling).rbg)-1)
							);
