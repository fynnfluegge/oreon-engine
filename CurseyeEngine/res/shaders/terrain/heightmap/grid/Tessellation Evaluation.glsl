...
void main(){
	...
	float height =   (
					  texture(heightmap, texCoord).r * 0
					+ texture(fractals0[0].heightmap, texCoord*fractals0[0].scaling).r * fractals0[0].strength
					+ texture(fractals0[1].heightmap, texCoord*fractals0[1].scaling).r * fractals0[1].strength
					+ texture(fractals0[2].heightmap, texCoord*fractals0[2].scaling).r * fractals0[2].strength
					+ texture(fractals0[3].heightmap, texCoord*fractals0[3].scaling).r * fractals0[3].strength
					+ texture(fractals0[4].heightmap, texCoord*fractals0[4].scaling).r * fractals0[4].strength
					+ texture(fractals0[5].heightmap, texCoord*fractals0[5].scaling).r * fractals0[5].strength
					+ texture(fractals0[6].heightmap, texCoord*fractals0[6].scaling).r * fractals0[6].strength
					) * scaleY;
