package engine.renderpipeline.shaderPrograms.materials;
...
public class Glass extends Shader{
	...
	protected Glass()
	{
		...
		addVertexShader(ResourceLoader.loadShader("materials/glass/Vertex.glsl"));
		addFragmentShader(ResourceLoader.loadShader("materials/glass/Fragment.glsl"));
		compileShader();
