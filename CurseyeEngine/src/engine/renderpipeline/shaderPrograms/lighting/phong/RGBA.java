...
public class RGBA extends Shader{
	...
	protected RGBA()
	{
		...
		addVertexShader(ResourceLoader.loadShader("lighting/phong/rgba/Vertex.glsl"));
		addFragmentShader(ResourceLoader.loadShader("lighting/phong/rgba/Fragment.glsl"));
		compileShader();
