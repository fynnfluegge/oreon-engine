...
public class Bumpy extends Shader{
	...
	protected Bumpy()
	{
		...
		addVertexShader(ResourceLoader.loadShader("lighting/phong/bumpy/Vertex.glsl"));
		addGeometryShader(ResourceLoader.loadShader("lighting/phong/bumpy/Geometry.glsl"));
		addFragmentShader(ResourceLoader.loadShader("lighting/phong/bumpy/Fragment.glsl"));
		compileShader();
