...
private static Textured instance = null;
	...
	protected Textured()
	{
		...
		addVertexShader(ResourceLoader.loadShader("shaders/phong/texture/Vertex.glsl"));
		addFragmentShader(ResourceLoader.loadShader("shaders/phong/texture/Fragment.glsl"));
		compileShader();
