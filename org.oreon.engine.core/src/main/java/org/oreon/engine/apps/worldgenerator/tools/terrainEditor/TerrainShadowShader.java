package org.oreon.engine.apps.worldgenerator.tools.terrainEditor;

import static org.lwjgl.opengl.GL13.GL_TEXTURE15;
import static org.lwjgl.opengl.GL13.glActiveTexture;
import org.oreon.engine.modules.terrain.TerrainConfiguration;
import org.oreon.engine.modules.terrain.TerrainNode;
...
protected TerrainShadowShader(){
		...
		addGeometryShader(ResourceLoader.loadShader("editor/terrainEditor/TerrainShadow_GS.glsl"));
		addFragmentShader(ResourceLoader.loadShader("editor/terrainEditor/TerrainGrid_FS.glsl"));
		compileShader();
