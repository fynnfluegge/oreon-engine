...
import org.oreon.engine.modules.gui.GUIObjectLoader;
import org.oreon.engine.modules.gui.GUIVAO;
import org.oreon.engine.engine.configs.AlphaBlending;
import org.oreon.engine.engine.core.CoreEngine;
...
public class FPSPanel extends GUIElement{
	...
	public FPSPanel(){
		...
		getOrthoTransform().setTranslation(Window.getInstance().getWidth()-75, Window.getInstance().getHeight()-60, 0);
