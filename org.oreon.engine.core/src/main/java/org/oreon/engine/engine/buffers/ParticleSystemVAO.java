package org.oreon.engine.engine.buffers;
...
import org.oreon.engine.engine.geometry.Particle;
...
public class ParticleSystemVAO {
	...
	public void init(Particle[] particles)
	{
        ...
        glBufferData(GL_ARRAY_BUFFER, BufferUtil.createFlippedBufferAOS(particles), GL_DYNAMIC_DRAW);
